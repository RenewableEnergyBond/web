  ...
  <div class="max-w-lg mx-auto">
    ...
    >
      ...
      >
        ...
        <div 
          v-if="showError" 
          class="p-3 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3"
          role="alert"
          aria-live="polite"
        >
          <svg 
        ...
        <div 
          ...
          class="p-3 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3"
          role="alert"
          aria-live="polite"
        >
          <svg 
      ...
      <div v-if="showOptIn" class="flex items-start space-x-3">
        ...
        <div class="flex-1 space-y-1">
          ...
          <p 
            v-if="showError && props.showOptIn && !optInAccepted"
            id="optin-error"
            class="text-xs text-red-600"
            role="alert"
          >
