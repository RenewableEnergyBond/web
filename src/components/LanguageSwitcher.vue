...
<template>
  <div class="relative inline-block">
    ...
    <button
      ...
      class="bg-white text-primary border border-primary px-3 py-2 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 flex items-center gap-2 h-10"
    >
    ...
    <div 
      v-if="isOpen"
      class="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-10 min-w-full"
    >
      <button
